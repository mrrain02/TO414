...
# ANN Model
```{r}
ann_model <- neuralnet(shot_made_flag1 ~., data=nba_ann_train, hidden = 5, act.fct = "tanh")
...
tree_model <- C5.0(as.factor(true) ~ ., data = tree_train, costs = error_cost)
