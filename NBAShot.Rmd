...
```{r}
# Read in Sample Test Shot 


# Predict the % Accuracy of All Players 


# Output Which Player is more likely to score 
...
```{r}
# Read Test Row 
nba <- read.csv("player_test.csv", stringsAsFactors = TRUE)
