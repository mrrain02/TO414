...
levels(as.factor(p2))
levels(as.factor(nba_svm_test$shot_made_flag1))
...
confusionMatrix(as.factor(p4),as.factor(nba_svm_test$shot_made_flag1))
confusionMatrix(as.factor(p5),as.factor(nba_svm_test$shot_made_flag1))
confusionMatrix(as.factor(p6),as.factor(nba_svm_test$shot_made_flag1))
confusionMatrix(as.factor(p7),as.factor(nba_svm_test$shot_made_flag1))
confusionMatrix(as.factor(p8),as.factor(nba_svm_test$shot_made_flag1))
